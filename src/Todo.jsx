...
const style = {
  ...
  pin: 'bg-red-300 text-black p-2 rounded cursor-pointer transition-colors duration-200 select-none',
  unpin: 'text-black p-2 select-none rounded cursor-pointer transition-colors duration-200',
}
